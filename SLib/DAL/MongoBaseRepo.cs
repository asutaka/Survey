...
namespace SLib.DAL
{
    ...
    public abstract class MongoBaseRepo<T> : IMongoRepositoryBase<T> where T : BaseMongoDTO
    {
        #region Fields
        protected IMongoCollection<T> _collection;

        protected IMongoDatabase _database;
        protected ILogger<MongoBaseRepo<T>> _logger;
        ...
        public MongoBaseRepo(IMongoDatabase database, ILogger<MongoBaseRepo<T>> logger)
        {
            _database = database;
            _collection = _database.GetCollection<T>(GetCollectionName());
            _logger = logger;
