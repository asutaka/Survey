...
namespace StockLib.Service
{
    ...
    {
        public async Task SyncBCTC_Ximang(bool onlyLast = false)
        {
            try
            {
                ...
                {
                    await SyncBCTC_Ximang_KQKD(item, onlyLast);
                    await SyncBCTC_Ximang_CDKT(item, onlyLast);
                }
            }
            catch (Exception ex)
            {
        ...
        private async Task SyncBCTC_Ximang_KQKD(string code, bool onlyLast)
        {
            try
            {
        ...
        private async Task SyncBCTC_Ximang_CDKT(string code, bool onlyLast)
        {
            try
            {
                var time = GetCurrentTime();
