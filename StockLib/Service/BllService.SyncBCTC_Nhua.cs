...
namespace StockLib.Service
{
    ...
    {
        public async Task SyncBCTC_Nhua(bool onlyLast = false)
        {
            try
            {
                ...
                {
                    await SyncBCTC_Nhua_KQKD(item, onlyLast);
                    await SyncBCTC_Nhua_CDKT(item, onlyLast);
                }
            }
            catch (Exception ex)
            {
        ...
        private async Task SyncBCTC_Nhua_KQKD(string code, bool onlyLast)
        {
            try
            {
        ...
        private async Task SyncBCTC_Nhua_CDKT(string code, bool onlyLast)
        {
            try
            {
                var time = GetCurrentTime();
