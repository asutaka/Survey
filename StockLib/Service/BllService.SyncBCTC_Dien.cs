    ...
    public partial class BllService
    {
        public async Task SyncBCTC_Dien()
        {
            try
            {
                ...
                {
                    await SyncBCTC_Dien_KQKD(item);
                    await SyncBCTC_Dien_CDKT(item);
                }
            }
            catch (Exception ex)
            {
        ...
        private async Task SyncBCTC_Dien_KQKD(string code)
        {
            try
            {
        ...
        private async Task SyncBCTC_Dien_CDKT(string code)
        {
            try
            {
                var time = GetCurrentTime();
