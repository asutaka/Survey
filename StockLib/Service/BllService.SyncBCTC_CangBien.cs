...
namespace StockLib.Service
{
    ...
    {
        public async Task SyncBCTC_CangBien(bool onlyLast = false)
        {
            try
            {
                ...
                {
                    await SyncBCTC_CangBien_KQKD(item, onlyLast);
                    await SyncBCTC_CangBien_CDKT(item, onlyLast);
                }
            }
            catch (Exception ex)
            {
        ...
        private async Task SyncBCTC_CangBien_KQKD(string code, bool onlyLast)
        {
            try
            {
        ...
        private async Task SyncBCTC_CangBien_CDKT(string code, bool onlyLast)
        {
            try
            {
                var time = GetCurrentTime();
