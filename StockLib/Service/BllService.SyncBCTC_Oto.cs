...
namespace StockLib.Service
{
    ...
    {
        public async Task SyncBCTC_Oto(bool onlyLast = false)
        {
            try
            {
                ...
                {
                    await SyncBCTC_Oto_KQKD(item, onlyLast);
                    await SyncBCTC_Oto_CDKT(item, onlyLast);
                }
            }
            catch (Exception ex)
            {
        ...
        private async Task SyncBCTC_Oto_KQKD(string code, bool onlyLast)
        {
            try
            {
        ...
        private async Task SyncBCTC_Oto_CDKT(string code, bool onlyLast)
        {
            try
            {
                var time = GetCurrentTime();
