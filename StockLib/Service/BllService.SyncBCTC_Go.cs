...
namespace StockLib.Service
{
    ...
    {
        public async Task SyncBCTC_Go(bool onlyLast = false)
        {
            try
            {
                ...
                {
                    await SyncBCTC_Go_KQKD(item, onlyLast);
                    await SyncBCTC_Go_CDKT(item, onlyLast);
                }
            }
            catch (Exception ex)
            {
        ...
        private async Task SyncBCTC_Go_KQKD(string code, bool onlyLast)
        {
            try
            {
        ...
        private async Task SyncBCTC_Go_CDKT(string code, bool onlyLast)
        {
            try
            {
                var time = GetCurrentTime();
