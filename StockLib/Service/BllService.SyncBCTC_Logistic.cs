...
namespace StockLib.Service
{
    ...
    {
        public async Task SyncBCTC_Logistic(bool onlyLast = false)
        {
            try
            {
                ...
                {
                    await SyncBCTC_Logistic_KQKD(item, onlyLast);
                    await SyncBCTC_Logistic_CDKT(item, onlyLast);
                }
            }
            catch (Exception ex)
            {
        ...
        private async Task SyncBCTC_Logistic_KQKD(string code, bool onlyLast)
        {
            try
            {
        ...
        private async Task SyncBCTC_Logistic_CDKT(string code, bool onlyLast)
        {
            try
            {
                var time = GetCurrentTime();
