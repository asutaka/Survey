...
namespace StockLib.Service
{
    ...
    {
        public async Task SyncBCTC_DetMay(bool onlyLast = false)
        {
            try
            {
                ...
                {
                    await SyncBCTC_DetMay_KQKD(item, onlyLast);
                    await SyncBCTC_DetMay_CDKT(item, onlyLast);
                }
            }
            catch (Exception ex)
            {
        ...
        private async Task SyncBCTC_DetMay_KQKD(string code, bool onlyLast)
        {
            try
            {
        ...
        private async Task SyncBCTC_DetMay_CDKT(string code, bool onlyLast)
        {
            try
            {
                var time = GetCurrentTime();
