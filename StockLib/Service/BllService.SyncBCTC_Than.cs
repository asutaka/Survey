...
namespace StockLib.Service
{
    ...
    {
        public async Task SyncBCTC_Than(bool onlyLast = false)
        {
            try
            {
                ...
                {
                    await SyncBCTC_Than_KQKD(item, onlyLast);
                    await SyncBCTC_Than_CDKT(item, onlyLast);
                }
            }
            catch (Exception ex)
            {
        ...
        private async Task SyncBCTC_Than_KQKD(string code, bool onlyLast)
        {
            try
            {
        ...
        private async Task SyncBCTC_Than_CDKT(string code, bool onlyLast)
        {
            try
            {
                var time = GetCurrentTime();
