...
namespace StockLib.Service
{
    public partial class BllService
    {
        ...
        private async Task<Stream> Chart_CaoSu_TonKho(List<Financial> lFinancial, string code)
        {
            try
            {
                var time = GetCurrentTime();
        ...
        private async Task<Stream> Chart_CaoSu_NoTaiChinh(List<Financial> lFinancial, string code)
        {
            try
            {
                var time = GetCurrentTime();
