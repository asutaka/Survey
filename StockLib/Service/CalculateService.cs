...
namespace StockLib.Service
{
    ...
    {
        Task<(int, List<string>)> ChiBaoKyThuat(DateTime dt);
    }
    public class CalculateService : ICalculateService
    {
        ...
        public async Task<(int, List<string>)> ChiBaoKyThuat(DateTime dt)
        {
            try
            {
            ...
            {
                _logger.LogError($"CalculateService.ChiBaoKyThuat|EXCEPTION| {ex.Message}");
            }
