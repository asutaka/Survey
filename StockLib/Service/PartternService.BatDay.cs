...
namespace StockLib.Service
{
    public partial class PartternService
    {
        public async Task BatDay(string code)
        {
            ...
            {
                _code = code;
                var lByBit = await StaticVal.ByBitInstance().V5Api.ExchangeData.GetKlinesAsync(Bybit.Net.Enums.Category.Linear, code, Bybit.Net.Enums.KlineInterval.OneHour, null, null, 1000);
