    ...
    public partial class BllService
    {
        public async Task SyncBCTC_ThuySan()
        {
            try
            {
                ...
                {
                    await SyncBCTC_ThuySan_KQKD(item);
                    await SyncBCTC_ThuySan_CDKT(item);
                }
            }
            catch (Exception ex)
            {
        ...
        private async Task SyncBCTC_ThuySan_KQKD(string code)
        {
            try
            {
        ...
        private async Task SyncBCTC_ThuySan_CDKT(string code)
        {
            try
            {
                var time = GetCurrentTime();
