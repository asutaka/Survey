    ...
    public partial class BllService
    {
        public async Task SyncBCTC_BanLe()
        {
            try
            {
                ...
                {
                    await SyncBCTC_BanLe_KQKD(item);
                    await SyncBCTC_BanLe_CDKT(item);
                }
            }
            catch (Exception ex)
            {
        ...
        private async Task SyncBCTC_BanLe_KQKD(string code)
        {
            try
            {
        ...
        private async Task SyncBCTC_BanLe_CDKT(string code)
        {
            try
            {
                var time = GetCurrentTime();
