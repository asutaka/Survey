...
namespace StockLib.Service
{
    ...
    {
        public async Task SyncBCTC_DauKhi(bool onlyLast = false)
        {
            try
            {
                ...
                {
                    await SyncBCTC_DauKhi_KQKD(item, onlyLast);
                    await SyncBCTC_DauKhi_CDKT(item, onlyLast);
                }
            }
            catch (Exception ex)
            {
        ...
        private async Task SyncBCTC_DauKhi_KQKD(string code, bool onlyLast)
        {
            try
            {
        ...
        private async Task SyncBCTC_DauKhi_CDKT(string code, bool onlyLast)
        {
            try
            {
                var time = GetCurrentTime();
