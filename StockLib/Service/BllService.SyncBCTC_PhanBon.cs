...
namespace StockLib.Service
{
    ...
    {
        public async Task SyncBCTC_PhanBon(bool onlyLast = false)
        {
            try
            {
                ...
                {
                    await SyncBCTC_PhanBon_KQKD(item, onlyLast);
                    await SyncBCTC_PhanBon_CDKT(item, onlyLast);
                }
            }
            catch (Exception ex)
            {
        ...
        private async Task SyncBCTC_PhanBon_KQKD(string code, bool onlyLast)
        {
            try
            {
        ...
        private async Task SyncBCTC_PhanBon_CDKT(string code, bool onlyLast)
        {
            try
            {
                var time = GetCurrentTime();
