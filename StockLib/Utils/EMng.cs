...
namespace StockLib.Utils
{
    ...
    public enum EKeyTongCucThongKe
    {
        ...
        VanTai_HangKhong = 29,
        [Display(Name = "Vận tải trong nước")]
        VanTai_TrongNuoc = 30,
        [Display(Name = "Vận tải nước ngoài")]
        VanTai_NuocNgoai = 31,
        ...
        XK_SatThep = 43,
        [Display(Name = "SP sắt thép")]
        XK_SPSatThep = 44,
        [Display(Name = "Dây điện")]
        XK_DayDien = 45,
        [Display(Name = "NK Phân bón")]
        NK_PhanBon = 46,
        [Display(Name = "NK Sắt thép")]
        NK_SatThep = 47,
        [Display(Name = "NK SP sắt thép")]
        NK_SPSatThep = 48,
        [Display(Name = "NK Ô tô")]
        NK_Oto = 49,
